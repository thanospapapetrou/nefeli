...
public interface OaiPmh {
	 ...
	 * 
	 * @param identifier
	 *            the <code>identifier</code> request argument or <code>null</code> to leave it unspecified
	 ...
	 *            the <code>resumptionToken</code> request argument
	 * @return the <code>ListSets</code> OAI-PMH response element
	 * @throws HTTPException
	 *             if any HTTP error occurs
	 * @throws InterruptedException
	 ...
	 * @param from
	 *            the <code>from</code> request argument or <code>null</code> to leave it unspecified
	 * @param until
	 *            the <code>until</code> request argument or <code>null</code> to leave it unspecified
	 * @param set
	 *            the <code>set</code> request argument or <code>null</code> to leave it unspecified
